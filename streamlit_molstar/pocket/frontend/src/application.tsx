...
export async function renderProteinView(proteinFile: any, pocketsFile: any) {
  ...
  const container = (window.innerWidth >= 480) ? document.getElementById('pocket-list-aside') : document.getElementById('pocket-list-aside-mobile');
...
export class Application extends React.Component<ReactApplicationProps, ReactApplicationState> 
{
  ...
  async loadData() {
    ...
    const {molstarPlugin, proteinFile, pocketsFile} = this.props;
